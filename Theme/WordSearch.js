let theWords = ['world', 'hello', 'planets', 'mars', 'earth', 'moon', 'jupyter', 'saturn', 'mercury', 'venus']
var theme = sessionStorage.getItem("thememe");
if (theme == "animal") {
  theWords = ['tiger', 'lion', 'parrot', 'monkey', 'human', 'deer', 'rabbit', 'fish', 'whale', 'shark'];
}
else if (theme == "movie") {
  theWords = ['magic', 'nemo', 'superman', 'batman', 'strange', 'panther', 'antman', 'avenger', 'marvel', 'queen'];
}
else {
  theWords = ['world', 'hello', 'planets', 'mars', 'earth', 'moon', 'jupyter', 'saturn', 'mercury', 'venus'];
}
